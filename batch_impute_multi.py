...
from model.config import (VOCAB_SIZE_COLUMNS, MAX_SEQUENCE_LENGTH, 
...
from predict_properties.collate_finetune import create_fine_collate_fn
...
def main():
    ...
    out_path = f"predict_properties/{out_name}"
